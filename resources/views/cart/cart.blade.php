...
<html>
<head>
	<title>Hidtzz Store - Shopping Cart</title>
	<meta charset="utf-8">
	 						...
	 						<div class="items">
                                ...
                                <a href="{{ url('/cart/delete/'.$data->id) }}" style="text-decoration:none;color: black"><i  class="fa-solid fa-xmark d-flex justify-content-start" style="margin:20px 20px"></i></a>
                                    <div class="product">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <img class="img-fluid mx-auto d-block image" style="padding: 30px" src="{{ asset('product/img/'.$data->product[0]->image) }}" alt="{{ $data->image }}">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="info">
                                                    <div class="row">
