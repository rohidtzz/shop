		        ...
		        <div class="content">
	 				<div class="row">
						 						...
						 						<div class="row">
							 						...
							 						<div class="col-md-4 quantity">
                                                        ...
                                                        <table class="" >
                                                            <tr>
                                                                <td><a class="btn">-</a></td>
                                                                <td><input id="quantity" type="number" value ="1" class="form-control quantity-input text-center"></td>
                                                                <td><a class="btn">+</a></td>
                                                            </tr>
                                                        </table>
                                                    </center>
							 						...
							 						<div class="col-md-3 price">
                                                        {{-- <label for="quantity">Price: </label><br> --}}
							 							<span class="fst-italic">&nbsp; 100.000</span>
							 						</div>
							 					</div>
							 				</div>
					 					</div>
			 			...
			 			<div class="col-md-12 col-lg-4">
			 				<div class="summary">
			 					<h3>Summary</h3>
			 					<div class="summary-item"><span class="text">Subtotal</span><span class="price">Rp. 100.000</span></div>
			 					<div class="summary-item"><span class="text">Shipping</span><span class="price">Rp. 0</span></div>
			 					<div class="summary-item"><span class="text">Total</span><span class="price">Rp. 100.000</span></div>
