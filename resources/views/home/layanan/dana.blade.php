        ...
        <div class="col-12">
            <div class="card" style="margin: 5%">
                <div class="card-header">
                    <img src="https://cdn.mobilepulsa.net/img/product/operator_list/140119034905-Dana-01.png" alt="">
                </div>
                <div class="card-body">
                    <form action="/2">
                                    ...
                                    <div  class=  "card-body"  >
                                        <div class="row">
                                            <div class="col-6 text-start" style="padding:7px">
                                                <input required name="code" value="{{ $datas->product_code}}" type="radio"> {{ $datas->product_description}} {{ $datas->product_nominal}}
                                            </div>
